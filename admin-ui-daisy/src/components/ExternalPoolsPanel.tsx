            ...
            <div className="grid gap-4 lg:grid-cols-2">
              ...
              <FormSection title="显式直连" description="命中规则后绕过本地凭证，直接进入外部池。">
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <ToggleRow disabled={!directPolicyActive} label="本地维护时直连" checked={configDraft.directExternalOnLocalMaintenance} onChange={(directExternalOnLocalMaintenance) => setConfigDraft((prev) => ({ ...prev, directExternalOnLocalMaintenance }))} />
                </div>
