        ...
        <div className="space-y-4">
          ...
          >
            <div className="grid gap-3 md:grid-cols-4">
              ...
              <ToggleRow disabled={!autoDisableActive} label="通道禁用自动禁用" checked={configDraft.externalPoolAutoDisableOnChannelDisabled} onChange={(externalPoolAutoDisableOnChannelDisabled) => setConfigDraft((prev) => ({ ...prev, externalPoolAutoDisableOnChannelDisabled }))} />
