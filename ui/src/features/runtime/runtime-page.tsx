...
export function RuntimePage() {
  ...
  useEffect(() => {
    if (config.data) {
      ...
      const accountRuntime = {
        ...defaultExternalPoolsConfig(),
        ...config.data.accountRuntime,
        externalPoolRouteMode: normalizeExternalPoolRouteMode(config.data.accountRuntime?.externalPoolRouteMode),
        externalPoolRouteRules: normalizeRuleList(config.data.accountRuntime?.externalPoolRouteRules),
      }
      setDraft({
        ...emptyRuntimeConfig,
        ...config.data,
      ...
      setExternalRouteRulesText(ruleText(accountRuntime.externalPoolRouteRules))
