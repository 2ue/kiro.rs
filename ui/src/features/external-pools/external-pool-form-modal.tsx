...
function TextBox({ label, description, value, disabled = false, className, onChange }: {
  label: string; description?: string; value: string; disabled?: boolean; className?: string; onChange: (v: string) => void
}) {
  return (
...
function TextAreaBox({ label, description, value, disabled = false, action, onChange }: {
  label: string; description?: string; value: string; disabled?: boolean; action?: ReactNode; onChange: (v: string) => void
}) {
  return (
    <div>
      ...
      <Textarea className="min-h-24 w-full font-mono text-xs" value={value} disabled={disabled} onChange={(e) => onChange(e.target.value)} />
    </div>
  )
}
