...
See `account-runtime-evidence-sources.md` for project-specific query examples.
...
For official Account Runtime/upstream errors, preserve the upstream message verbatim after redacting secrets and account identifiers.
