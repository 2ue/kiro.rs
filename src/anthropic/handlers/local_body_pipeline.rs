...
pub(super) fn prepare_with_plan(
    ...
    let conversion_result = match convert_request_with_resolved_model(
        ...
        ConverterOptions {
            ...
            local_upstream_cache_point_enabled: cache_route.policy.cache_point.enabled,
            local_upstream_cache_point_tools_only: cache_route.policy.cache_point.tools_only,
            local_upstream_cache_point_record_plan: cache_route.policy.cache_point.record_plan,
