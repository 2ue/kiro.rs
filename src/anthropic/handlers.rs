...
struct AccountFallbackContext {
    ...
    prompt_cache_creation_control: PromptCacheCreationControlConfig,
    prompt_cache_bounds: PromptCacheBounds,
    claude_code_tool_cache_policy: ClaudeCodeToolCachePolicy,
...
fn build_account_fallback_context(
    ...
    Some(AccountFallbackContext {
        ...
        recorder: state.usage_recorder.clone(),
        error_id: envelope::request_id(),
        payload_guard_account_enabled: runtime_config.payload_guard_account_enabled,
        payload_guard_initial_config: runtime_config.initial_payload_guard_config(),
        payload_guard_retry_config: (runtime_config.payload_guard_account_enabled
...
impl AccountFallbackContext {
    ...
    fn route_request(
        ...
        Ok(AccountRouteRequest {
            ...
            claude_code_tool_cache_policy: self.claude_code_tool_cache_policy,
            ...
            payload_breakdown: None,
            payload_guard_report: None,
            payload_guard_external_enabled: self.payload_guard_account_enabled,
...
fn prepare_usage_context_with_inference_attempt_budget(
    ...
    let (prompt_cache_profile, claude_code_tool_prompt_cache_plan) = match strategy_type {
...
fn local_fallback_reason_blocks_local_rescue(
    reason: Option<&str>,
    _current_local_dispatchable: Option<usize>,
) -> bool {
    matches!(
        reason,
        Some(
