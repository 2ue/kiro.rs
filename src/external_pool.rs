...
const EXTERNAL_POOL_USAGE_DEBUG_DEFAULT_DIR: &str =
    "/tmp/account-runtime/upstream-account-usage-debug";
...
pub struct ExternalRouteRequest {
    ...
    pub claude_code_tool_cache_policy: ClaudeCodeToolCachePolicy,
