...
| [Credential scheduler hot-path analysis](../../../../archive/scheduler-state-external-pool-runtime-history/credential-scheduler-hotpath-performance-analysis.md) | Historical implementation/performance analysis | Revalidate hot-path claims against current manager/storage code before reuse |
| [Redis and PgSQL state-model analysis](../../../../archive/scheduler-state-external-pool-runtime-history/redis-pgsql-state-model-full-analysis.md) | Reference analysis, partially stale | Reuse evidence and options; current code, baseline, runtime-correctness plan, and accepted state decisions win |
| [Runtime usage and scheduler performance fix](../../../../archive/scheduler-state-external-pool-runtime-history/runtime-usage-scheduler-performance-fix-20260620.md) | Historical implementation record, partially superseded | Its Redis-failure local fallback and background-only release semantics are superseded by the runtime-correctness plan's fail-closed and critical-release behavior |
| [Scheduler dispatch redesign](../../../../archive/scheduler-dispatch-redesign-history/scheduler-dispatch/README.md) | Historical landed behavior index | Preserve external scheduler semantics unless an accepted decision and characterization tests change them |
| [Account Runtime optimization plans](../../../../archive/account-runtime-proxy-study-and-optimization-20260626/account-runtime-optimization-plans-20260626/README.md) | Historical proposal collection | Use as an idea/source catalog; do not infer that every proposal remains active or unimplemented |
| [External fallback pools design](../../../../archive/scheduler-state-external-pool-runtime-history/external-fallback-pools-design.md) | Historical contract/design source | Use to trace public configuration intent such as `preservePath`; current API contract and code reveal any implementation drift |
| [Prompt-cache strategy family analysis](../../../../archive/cache-usage-and-production-history/prompt-cache-strategy-family-refactor-analysis-20260701.md) | Historical cache analysis | Reuse examples and policy rationale; target usage/cache contracts must restate accepted semantics without copying stale implementation detail |
| [Current cache strategy issues](../../../../archive/cache-usage-and-production-history/current-cache-strategy-issues-readable-20260701.md) | Historical problem analysis | Reproduce unresolved claims before promoting them into the current problem catalog |
| [Account Runtime proxy study](../../../../archive/account-runtime-proxy-study-and-optimization-20260626/account-runtime-proxy-study-20260626/README.md) | External-project research | Use for alternatives, never as current-project authority |
