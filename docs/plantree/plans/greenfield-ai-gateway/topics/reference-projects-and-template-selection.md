...
The new project independently defines module contracts, execution lifecycle, delivery evidence, replay safety, Account Runtime leases, usage facts, configuration publication and terminal semantics.
...
| [AWS SDK for Go v2](https://github.com/aws/aws-sdk-go-v2) EventStream | Apache-2.0; updated 2026-07-10 | preferred Account Runtime framing/CRC decoder if compatibility tests pass |
