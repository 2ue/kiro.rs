...
- Rename concrete local-upstream credential, call-trace, available-model and event model types so Kiro-specific runtime names shrink toward explicit compatibility-only fields.
