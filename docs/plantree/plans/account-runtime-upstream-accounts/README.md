...
- `feature/tests/run-cargo-scoped.sh account-runtime-drop-provider-state-fmt8 -- cargo fmt`
- `feature/tests/run-cargo-scoped.sh account-runtime-drop-provider-state-check5 -- cargo check`
- `feature/tests/run-cargo-scoped.sh account-runtime-drop-provider-state-test5 -- bash -lc 'cargo test local_upstream_impl::provider::tests::model -- --nocapture && cargo test account_only_routes_normalized_requests_without_local_upstream_provider -- --nocapture'`
- Earlier same-slice focused coverage also passed: `feature/tests/run-cargo-scoped.sh account-runtime-drop-provider-state-test3 -- bash -lc 'cargo test anthropic::model_capabilities::tests -- --nocapture && cargo test local_upstream_impl::endpoint -- --nocapture && cargo test local_upstream_impl::provider::tests::model -- --nocapture && cargo test admin::service_tests::normalizes_discovered_supported_models -- --nocapture && cargo test account_only_routes_normalized_requests_without_local_upstream_provider -- --nocapture'`
- `feature/tests/run-cargo-scoped.sh account-runtime-handler-provider-state-fmt3 -- cargo fmt`
- `feature/tests/run-cargo-scoped.sh account-runtime-handler-provider-state-check3 -- cargo check`
- `feature/tests/run-cargo-scoped.sh account-runtime-handler-provider-state-test1 -- bash -lc 'cargo test account_only_routes_normalized_requests_without_local_upstream_provider -- --nocapture && cargo test local_upstream_impl::provider::tests::model -- --nocapture'`
- `feature/tests/run-cargo-scoped.sh account-runtime-no-tier-labels-fmt1 -- cargo fmt`
- `feature/tests/run-cargo-scoped.sh account-runtime-no-tier-labels-check1 -- cargo check`
- `feature/tests/run-cargo-scoped.sh account-runtime-no-tier-labels-test1 -- bash -lc 'cargo test local_upstream_impl::model::usage_limits -- --nocapture && cargo test anthropic::model_capabilities::tests::catalog_reasoning_state_is_authoritative_and_cohort_fenced_for_five_rounds -- --nocapture'`
- `feature/tests/run-cargo-scoped.sh account-runtime-no-tier-labels-test2 -- cargo test storage::postgres::tests::postgres_persists_runtime_config_credentials_stats_usage_and_pricing -- --nocapture`
- `feature/tests/run-cargo-scoped.sh account-runtime-handler-local-tail-fmt5 -- cargo fmt`
- `feature/tests/run-cargo-scoped.sh account-runtime-handler-local-tail-check4 -- cargo check`
- `feature/tests/run-cargo-scoped.sh account-runtime-handler-local-tail-test2 -- cargo test local_upstream_impl::provider::tests::model -- --nocapture`
- `feature/tests/run-cargo-scoped.sh account-runtime-handler-local-tail-test3 -- bash -lc 'cargo test account_only_routes_normalized_requests_without_local_upstream_provider -- --nocapture && cargo test anthropic::websearch -- --nocapture'`
