# Slow first token and stream fluidity analysis, 2026-06-29 to 2026-07-09

Role: Preserved historical analysis collection
...
- The files are dated analysis artifacts from earlier production/performance investigations.
- They are useful as background evidence but are no longer current execution plans.
- Current scheduler/runtime work is tracked in the registered plan-tree plan linked above.
- Direct inbound Markdown references were not found during the 2026-07-28 audit batch.

## Recovery

No file was deleted. To restore a file to its original location, move it back from this archive and update the archive index and any links introduced after archival.
