...
```bash
cargo run --bin account_runtime_loadtest -- --scenario normal_stream
cargo run --bin account_runtime_loadtest -- --scenario stream_idle_timeout
cargo run --bin account_runtime_loadtest -- --scenario recovery_after_burst
```
