...
> Archive status: Historical current-state snapshot; revalidate every claim before reuse.
>
> Original path: `ui/docs/dashboard-enhancement/00-background.md`. Current disposition and authority: [operator UI planning archive](../README.md).
