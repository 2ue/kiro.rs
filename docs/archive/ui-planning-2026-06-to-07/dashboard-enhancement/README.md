...
> Archive status: Historical enhancement plan and candidate source; not an active roadmap.
>
...
- 当时引用的设计系统 companion 已删除；见 [archive provenance](../README.md#deleted-companions)。相关规则仅是历史输入，当前组件与 R8 browser/accessibility contract 才是复用依据。
...
本方案当时定位为"做加法"（增强能力）；另一个已删除的历史功能审计 companion 定位为"补欠账"。其删除来源见 [archive provenance](../README.md#deleted-companions)，两处历史交集仍在分册中保留供 R8 重新审计：
